        ...
        if (!uploading) {
            ...
            axiosInstance.post('/admin/topup-product/create', {
                ...
                if (newId && selectedCategoryIds.length) {
                    try {
                        await axiosInstance.post(`/admin/topup-product/${newId}/categories`, {
                            ...
                            <div>
                                <div className="form_grid">
                                    ...
                                    <div>
                                        ...
                                        <input ref={price} id="price" className="form_input" type="number" placeholder="Price" required />
                                    </div>
                                </div>
                                ...
                                <div className="my-3">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        {(!categories || categories.length === 0) && (
                                            <span className="text-sm text-gray-500">No categories yet — create some in /categories</span>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="my-2" >
                                    <label className="py-2 inline-block cursor-pointer select-none" >
                                        <input type="checkbox" ref={isactivefortopup} className="mr-2" />
